...
const Login = () => {
    ...
    <div className="mb-4">
      ...
      <div><input type="email" required className="w-100" name="email" v-model="email"/></div> 
    </div>
    <div className="mb-4">
      <div><label>Пароль</label></div>
      <div><input type="password" required className="w-100" name="password" v-model="password"/></div>
    </div>
    <div className="mb-4">
