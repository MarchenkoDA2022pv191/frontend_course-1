...
class CreateMonsterTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('monster', function (Blueprint $table) {
            ...
            $table->decimal("level",5,3,true) ->default(1)->comment("Уровень");
            $table->smallInteger("streight")->default(1)->comment("Сила");
            ...
            $table->string("image")->default("https://www.clipartmax.com/png/middle/474-4749661_question-mark-clipart-lime-green-question-mark-clipart-lime-green.png")->comment("Описание");
            $table->timestamps();
        });
    }
